<nav x-data="{ open: false }" class="bg-primary sticky-top shadow">
        ...
        <div class="flex justify-between h-16 items-center">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('infrastructure')" :active="request()->routeIs('infrastructure')">
                        Infrastructure
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('infrastructure')" :active="request()->routeIs('infrastructure')">
                Infrastructure
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admission')" :active="request()->routeIs('admission')">
                Admission
            </x-responsive-nav-link>
